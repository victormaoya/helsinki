...
describe('total likes', () => {
  ...
  test('for a list with zero blogs equals to zero likes', () => {
    assert.strictEqual(totalLikes(listWithZeroBlogs), 0)
  })
  ...
  test('for a list with more than blog equals to the sum of all likes', () => {
